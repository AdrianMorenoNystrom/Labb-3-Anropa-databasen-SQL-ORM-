...
namespace LABB3
{
    public class ChoiceManager
    {
        public void ShowChoices()
        {
            ...
            Console.WriteLine("4. Hämta en lista på alla betyg satt den senaste månaden.");
            Console.WriteLine("5. Hämta en lista på alla kurser i databasen, snittbetyget samt det högsta och lägsta betyget för varje kurs.");
            Console.WriteLine("6. Lägg till en elev i databasen");
            Console.WriteLine("7. Lägg till en anställd i databasen");
